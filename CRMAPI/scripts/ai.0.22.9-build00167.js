    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            (function (CRMWebApi) {
                ...
                CRMWebApi.Envelope = Envelope;
            })(CRMWebApi = Telemetry.CRMWebApi || (Telemetry.CRMWebApi = {}));
...
/// <reference path="Telemetry/CRMWebApi/Envelope.ts"/>
/// <reference path="Telemetry/CRMWebApi/Base.ts" />
    ...
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            (function (CRMWebApi) {
                ...
                CRMWebApi.DataSanitizer = DataSanitizer;
            })(CRMWebApi = Telemetry.CRMWebApi || (Telemetry.CRMWebApi = {}));
        })(Telemetry = ApplicationInsights.Telemetry || (ApplicationInsights.Telemetry = {}));
    })(ApplicationInsights = Microsoft.ApplicationInsights || (Microsoft.ApplicationInsights = {}));
})(Microsoft || (Microsoft = {}));
/// <reference path="../Contracts/Generated/MessageData.ts" />
/// <reference path="./CRMWebApi/DataSanitizer.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var Trace = (function (_super) {
                ...
                function Trace(message, properties) {
                    ...
                    this.message = Telemetry.CRMWebApi.DataSanitizer.sanitizeMessage(message);
                    this.properties = Telemetry.CRMWebApi.DataSanitizer.sanitizeProperties(properties);
                }
        ...
        (function (Telemetry) {
            ...
            var Event = (function (_super) {
                ...
                function Event(name, properties, measurements) {
                    ...
                    this.name = ApplicationInsights.Telemetry.CRMWebApi.DataSanitizer.sanitizeString(name);
                    this.properties = ApplicationInsights.Telemetry.CRMWebApi.DataSanitizer.sanitizeProperties(properties);
                    this.measurements = ApplicationInsights.Telemetry.CRMWebApi.DataSanitizer.sanitizeMeasurements(measurements);
                }
        ...
        (function (Telemetry) {
            ...
            var _ExceptionDetails = (function (_super) {
                ...
                function _ExceptionDetails(exception) {
                    ...
                    this.typeName = Telemetry.CRMWebApi.DataSanitizer.sanitizeString(exception.name || ApplicationInsights.Util.NotSpecified);
                    this.message = Telemetry.CRMWebApi.DataSanitizer.sanitizeMessage(exception.message || ApplicationInsights.Util.NotSpecified);
                    var stack = exception["stack"];
                    this.parsedStack = this.parseStack(stack);
                    this.stack = Telemetry.CRMWebApi.DataSanitizer.sanitizeException(stack);
...
/// <reference path="./CRMWebApi/DataSanitizer.ts" />
/// <reference path="./CRMWebApi/DataPoint.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
        ...
        (function (Telemetry) {
            ...
            var Metric = (function (_super) {
                ...
                function Metric(name, value, count, min, max, properties) {
                    ...
                    var dataPoint = new Microsoft.ApplicationInsights.Telemetry.CRMWebApi.DataPoint();
                    dataPoint.count = count > 0 ? count : undefined;
                    dataPoint.max = isNaN(max) || max === null ? undefined : max;
                    dataPoint.min = isNaN(min) || min === null ? undefined : min;
                    dataPoint.name = Telemetry.CRMWebApi.DataSanitizer.sanitizeString(name);
        ...
        (function (Telemetry) {
            ...
            var PageView = (function (_super) {
                ...
                function PageView(name, url, durationMs, properties, measurements) {
                    ...
                    this.url = Telemetry.CRMWebApi.DataSanitizer.sanitizeUrl(url);
                    this.name = Telemetry.CRMWebApi.DataSanitizer.sanitizeString(name || ApplicationInsights.Util.NotSpecified);
                    if (!isNaN(durationMs)) {
...
/// <reference path="./Telemetry/CRMWebApi/Data.ts"/>
/// <reference path="./Util.ts"/>
/// <reference path="./Contracts/Generated/SessionState.ts"/>
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                this._eventTracking.action = function (name, url, duration, properties, measurements) {
                    ...
                    var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Event.dataType, event);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Event.envelopeType);
            ...
            AppInsights.prototype.sendPageViewInternal = function (name, url, duration, properties, measurements) {
                ...
                var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.PageView.dataType, pageView);
                var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.PageView.envelopeType);
                this.context.track(envelope);
                this._trackAjaxAttempts = 0;
            };
            AppInsights.prototype.sendPageViewPerformanceInternal = function (pageViewPerformance) {
                var pageViewPerformanceData = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.PageViewPerformance.dataType, pageViewPerformance);
                var pageViewPerformanceEnvelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(pageViewPerformanceData, ApplicationInsights.Telemetry.PageViewPerformance.envelopeType);
            ...
            AppInsights.prototype.trackEvent = function (name, properties, measurements) {
                try {
                    ...
                    var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Event.dataType, eventTelemetry);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Event.envelopeType);
                    this.context.track(envelope);
                }
                catch (e) {
            ...
            AppInsights.prototype.trackAjax = function (id, absoluteUrl, pathName, totalTime, success, resultCode) {
                if (this.config.maxAjaxCallsPerView === -1 ||
                    ...
                    var dependencyData = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.RemoteDependencyData.dataType, dependency);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(dependencyData, ApplicationInsights.Telemetry.RemoteDependencyData.envelopeType);
                    this.context.track(envelope);
                }
            ...
            AppInsights.prototype.trackException = function (exception, handledAt, properties, measurements) {
                try {
                    ...
                    var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Exception.dataType, exceptionTelemetry);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Exception.envelopeType);
                    this.context.track(envelope);
                }
                catch (e) {
            ...
            AppInsights.prototype.trackMetric = function (name, average, sampleCount, min, max, properties) {
                try {
                    ...
                    var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Metric.dataType, telemetry);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Metric.envelopeType);
                    this.context.track(envelope);
                }
                catch (e) {
            ...
            AppInsights.prototype.trackTrace = function (message, properties) {
                try {
                    ...
                    var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Trace.dataType, telemetry);
                    var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Trace.envelopeType);
                    this.context.track(envelope);
                }
                catch (e) {
            ...
            AppInsights.prototype.SendCORSException = function (properties) {
                ...
                var data = new ApplicationInsights.Telemetry.CRMWebApi.Data(ApplicationInsights.Telemetry.Exception.dataType, exceptionData);
                var envelope = new ApplicationInsights.Telemetry.CRMWebApi.Envelope(data, ApplicationInsights.Telemetry.Exception.envelopeType);
                this.context.track(envelope);
            };
